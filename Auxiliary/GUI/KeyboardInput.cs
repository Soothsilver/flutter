...
namespace Auxiliary
{
    ...
    public class KeyboardInput : IDisposable
    {
        ...
        public KeyboardInput(IntPtr whnd)
        {
        ...
        protected virtual void OnKeyPress(KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar.GetHashCode().ToString() == "524296") { backSpace = true; }
            else
                if (e.KeyChar.GetHashCode().ToString() == "851981") { enter = true; } else { if (buffer.Length == 0 || buffer[buffer.Length - 1] != e.KeyChar) buffer += e.KeyChar; }
        }
